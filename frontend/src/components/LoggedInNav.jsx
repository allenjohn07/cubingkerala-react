...
import { Dropdown, DropdownTrigger, Avatar, DropdownMenu, DropdownItem, Button, Progress } from "@nextui-org/react";
import { useSnackbar } from 'notistack';

const LoggedInNav = ({isShow}) => {
    ...
    return (
        <div className='relative'>
            ...
            radius='none'
              ...
              isIndeterminate
              aria-label="Loading..."
              className={isShow ? "max-w-full absolute" : "hidden"}
            />
