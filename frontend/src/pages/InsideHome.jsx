...
const InsideHome = () => {
    return (
        <div className="bg-black min-h-screen cursor-default">
            ...
            <div className="p-8">
                {/* Hero Section */}
                <div className="welcome-section mb-8 p-8 text-gray-200 rounded shadow-md">
                ...
                {/* Events Section */}
                <div className="events-section mb-8 p-6 text-gray-200 rounded shadow-md">
                    <h3 className="text-2xl font-bold mb-4 text-gray-200">What’s Happening?</h3>
                ...
                <div className="member-spotlight-section mb-8 p-6 text-gray-200 rounded shadow-md">
                    <h3 className="text-2xl font-bold mb-4 text-gray-200">Member Spotlight: Meet John “The Juggler” Doe</h3>
                ...
                {/* Tips & Tricks Section */}
                <div className="tips-tricks-section mb-8 p-6 text-gray-200 rounded shadow-md">
                    <h3 className="text-2xl font-bold mb-4 text-gray-200">Tips & Tricks</h3>
                    <ul className="list-disc pl-5">
                ...
                {/* Merchandise Section */}
                <div className="merchandise-section mb-8 p-6 text-gray-200 rounded shadow-md">
                    <h3 className="text-2xl font-bold mb-4 text-gray-200">Merchandise: Because You Need More Cube Stuff</h3>
                    <ul className="list-disc pl-5">
                ...
                {/* Discussion Section */}
                <div className="discussion-section mb-8 p-6 text-gray-200 rounded shadow-md">
                    <h3 className="text-2xl font-bold mb-4 text-gray-200">Join the Discussion!</h3>
                ...
                {/* Help Section */}
                <div className="help-section mb-8 p-6 text-gray-200 rounded shadow-md">
                    <h3 className="text-2xl font-bold mb-4 text-gray-200">Need Help?</h3>
