          ...
          isLoading ? (
            ...
            <div className="px-8 py-0 lg:py-8 animate-fadeIn">
              ...
              <div className="mb-12">
                ...
                {
                  upcomingCompetitions.length > 0 ? <div className="grid grid-cols-1 gap-4 sm:grid-cols-1 lg:grid-cols-4">
                    {
                  ...
                  </div> : <div className='py-8 lg:py-20 text-start'>
                    <h1 className="text-lg lg:text-3xl font-semibold text-success">
                    New competitions are on the way!</h1>
                  </div>
                }
                {
